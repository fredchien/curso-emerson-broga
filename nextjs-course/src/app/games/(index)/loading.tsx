...
export default async function GamesLoading() {
    const placeholder = getIntArray(1, 12);
    return (
        <PageWrapper>
            <div className="container mx-auto my-6 animate-pulse">
                ...
                {placeholder.map((v: any) => {
                return (
                    <div key={v} >
                        <div className='flex-center flex-col relative overflow-hidden w-[372px] h-[312px]'>
            ...
            <div className='my-8'>
                <div className="bg-slate-600 w-full h-6 rounded-lg"></div>
            </div>
            </div>
        </PageWrapper>
    );
