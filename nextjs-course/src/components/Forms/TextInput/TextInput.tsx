    ...
    return (
        <div className={`my-4 ${className}`}>
            ...
            <input 
                ...
                name={name} 
                {...props}
                className={`my-2 w-full rounded-md border-2 border-transparent bg-slate-800 px-4 py-3 text-base text-slate-200 focus:outline-none focus:ring-0 ${!!error ? 'border-red-500': ''}`}/>
            {error ? 
                <div className="my-2">
